...
import NFTCollectibleAbi from 'config/abi/NFTCollectible.json'
import NFTCollectionManagerAbi from 'config/abi/NFTCollectionManager.json'
...
export const getNFTCollectibleContract = (address: string, signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(NFTCollectibleAbi.abi, address, signer)
}
export const getNFTCollectionManagerContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(NFTCollectionManagerAbi.abi, getNFTCollectionManagerAddress(), signer)
}