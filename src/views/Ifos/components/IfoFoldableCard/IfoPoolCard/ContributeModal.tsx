...
const ContributeModal: React.FC<Props> = ({
  ...
  const { isApproving, isApproved, isConfirmed, isConfirming, handleApprove, handleConfirm } =
    useApproveConfirmTransaction({
      ...
      onConfirm: () => {
        return callWithGasPrice(contract, 'deposit', [valueWithTokenDecimals.toString()], {
          gasPrice,
        })
      },
      ...
      <ModalBody maxWidth="355px">
        ...
        <Flex justifyContent="space-between" mb="8px">
          ...
          <Flex flexGrow={1} justifyContent="flex-end">
            <Image src={`/images/tokens/${currency.address}.svg`} width={24} height={24} mr="4px" />
        ...
        <Text color="textSubtle" fontSize="12px" mb="24px">
          {t(
            'If you don’t commit enough CNO tokens, you may not receive any CNFT tokens at all and will only receive a full refund of your CNO tokens.',
          )}
        </Text>
