        ...
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('Buy CNO tokens, or unstake yours from pools')} <br />
              {t('You’ll spend them to buy IFO sale tokens.')}
            </Text>
            <Button
              as={Link}
              external
              href="https://chronoswap.org/swap?outputCurrency=0x322e21dcAcE43d319646756656b29976291d7C76"
      ...
      case 1:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t('When the IFO sales are live, you can “commit” your CNO tokens to buy the tokens being sold.')} <br />
              {t('We work with overflow and unlimited model, the more you commit, the more you will get allocation.')}
            </Text>
          </CardBody>
        )
      case 2:
        return (
          <CardBody>
            ...
            <Text color="textSubtle" small>
              {t(
                'After the IFO sales finish, you can claim any IFO tokens that you bought, and any unspent CNO tokens will be returned to your wallet.',
              )}
            </Text>
          </CardBody>
        )
