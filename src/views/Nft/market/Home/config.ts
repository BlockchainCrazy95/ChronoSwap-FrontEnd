const config = [
  {
    ...
    description: [
      'Trades are settled in WCRO, which is a wrapped version of BNB used on Binance Smart Chain. That means that when you sell an item, WCRO is sent to your wallet instead of BNB.',
      'You can instantly swap your WCRO for BNB with no trading fees on PancakeSwap.',
    ],
  },
  {
