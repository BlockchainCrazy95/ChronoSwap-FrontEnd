        ...
        <Flex justifyContent="space-between" flexDirection={['column', null, null, 'row']}>
          <Flex flex="1" flexDirection="column" mr={['8px', 0]}>
            ...
            <Heading scale="md" color="text" mt="25px">
              {t('STAKE CNO. EARN TOKENS. SIMPLE.')}
            </Heading>
            <Heading scale="md" color="text">
              {t('High APR, low risk.')}
            </Heading>
            {/* <Flex width="300px" height="fit-content" justifyContent="center" alignItems="center" pt="52px">
              <BountyCard />
            </Flex> */}
          </Flex>
          <Flex flex="0.5" height="fit-content" justifyContent="center" alignItems="center" pt="52px">
            {/* <HelpButton /> */}
            <BountyCard />
            {/* <Image
              mx="auto"
              mt="12px"
              src="/images/chronoswap_logo_new.png"
              alt="ChronoSwap Logo"
              width={194}
              height={194}
            /> */}
          ...
          {/* <ArrowContainer flex="1" flexDirection="column" mt="60px;">
            <Heading scale="md" color="text">
              {t('📢 Race event live : Top 2 wallets with the most')}
            </Heading>
            <Heading scale="md" color="text">
              {t('CNO AUTO staked on 20th Dec. 9pm UTC and 1 random lucky staker will win a CroShark NFT 🦈')}
            </Heading>
            <Flex flex="1" mt="20px;">
              <a href="https://crosharks.club/#/" target="_blank" rel="noreferrer">
                <Button p="0" variant="text">
                  <Text color="primary" bold fontSize="16px" mr="4px">
                    {t('visit crosharks.club')}
                  </Text>
                  <ArrowForwardIcon color="primary" />
                </Button>
              </a>
              <Image mx="auto" src="/images/croshark-animated.gif" alt="Cro Sharks NFT Logo" width={200} height={200} />
            </Flex>
          </ArrowContainer> */}
        </Flex>
      </PageHeader>
